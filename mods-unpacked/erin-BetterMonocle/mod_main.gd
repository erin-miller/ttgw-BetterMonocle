...
func install_script_extensions() -> void:
	...
	ModLoaderMod.install_script_extension(extensions_dir_path.path_join("objects/globals/util.gd"))
...
func _ready() -> void:
	...
	var bm_script = load(extensions_dir_path.path_join("better_monocle.gd"))
	if bm_script:
